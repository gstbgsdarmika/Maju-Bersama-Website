...
// tombol cari ditekan
	if(isset($_POST["cariKategori"]) ) {
			$beasiswa = cariKategori($_POST["kategori"]);
			}
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <form action="" method="POST" class="d-flex">
                        <input class="form-control me-2" name="kategori" type="search" placeholder="Masukkan kategori yang ingin dicari" aria-label="Search" id="kategori">
                        <button class="btn btn-custom6 " type= submit" name="cariKategori" id="tombol-cariKategori">Cari</button>
                    </form>
                </div>
            </div>
			<div class="row">
                    ...
                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                ...
                                <li><a class="dropdown-item" href="cariTanggalBeasiswa.php">Tanggal</a></li>
                            </ul>
                        </div>
                    </div>
                </div>

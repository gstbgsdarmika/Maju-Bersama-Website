		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-8 text-center">
					<h2 class="fw-bold color-acsent2">Formulir Upload Beasiswa</h2>
                ...
                <div class="col-8">
                    <div class="formdaftarlomba mt-5">
                        ...
                        <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="judul_beasiswa" id="judul_beasiswa" aria-describedby="emailHelp">
                            </div>
                        <div class="mb-3">
                                <label for="exampleInputNo" class="form-label">Kategori beasiswa</label>
                                <input type="text" class="form-control" name="kategori_pendaftar" id="kategori_beasiswa" aria-describedby="emailHelp">
                            </div>
                        <div class="mb-3">
                                <label for="exampleInputNo" class="form-label">Deskripsi beasiswa</label>
                                <input type="text" class="form-control" name="deskripsi_beasiswa" id="deskripsi_beasiswa" aria-describedby="emailHelp">
                            </div>
                        <div class="mb-5">
                                <label for="exampleInputNo" class="form-label" for="tanggal_beasiswa">Tanggal beasiswa</label>
                                <input type="date" class="form-control" name="tanggal_beasiswa" id="tanggal_beasiswa" required>
                            </div>
                        <div class="mb-3">

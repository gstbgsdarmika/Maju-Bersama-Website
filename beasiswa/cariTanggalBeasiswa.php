...
$beasiswa = query("SELECT * FROM beasiswa");
	...
	if(isset($_POST["cariTanggal"]) ) {
		$beasiswa = cariTanggal($_POST["tanggal1"], $_POST ["tanggal2"]);
		}
 ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="fw-bold color-acsent mb-4">Daftar Informasi <span class="color-acsent2">Beasiswa</span></h2>
                    <form action="" method="post">
						<div class="input-group">
						<input type="date" name="tanggal1" id="tanggal1" aria-label="First name" class="form-control">
						<input type="date" name="tanggal2" id="tanggal2" aria-label="Last name" class="form-control">
						<button class="btn btn-custom6"type="submit" name="cariTanggal" id="tombol-cariTanggal">Rentang Tanggal</button>
						</div>
					</form>
                </div>
            </div>
                    ...
                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                <li><a class="dropdown-item" href="cariKeywordBeasiswa.php">Keyword</a></li>
                                <li><a class="dropdown-item" href="cariKategoriBeasiswa.php">Kategori</a></li>
                            </ul>
                        </div>
                    </div>
                </div>

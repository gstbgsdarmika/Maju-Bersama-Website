        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="fw-bold color-acsent mb-4">Daftar Beasiswa <span class="color-acsent2">MajuBersama</span></h2>
                    <form action="" method="POST" class="d-flex">
                        <input name="keyword" class="form-control me-2" type="search" placeholder="Cari Beasiswa Berdassarkan Keyword" aria-label="Search" autocomplete="off" id="keyword">

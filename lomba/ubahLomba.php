...
$mkn = query("SELECT * FROM lomba WHERE id_lomba = $id_lomba")[0];
...
<html lang="en">
    ...
    <!-- ubah lomba -->
	<section id="ubahlomba">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-8 text-center">
					<h2 class="fw-bold color-acsent2">Edit Formulir Lomba</h2>
			...
			<div class="row justify-content-center">
                <div class="col-8">
                    <div class="formdaftarlomba mt-5">
						...
						<input type="hidden" name="id_lomba" value="<?= $mkn["id_lomba"]; ?>">
		                <input type="hidden" name="gambarLama" value="<?= $mkn["gambar_lomba"]; ?>">
                        <div class="mb-3">
                                <label for="exampleInputNo" class="form-label">Judul Lomba</label>
                                <input type="text" class="form-control" name="judul_lomba" id="judul_lomba" aria-describedby="emailHelp" value="<?= $mkn ["judul_lomba"]; ?>">
                            </div>
                        <div class="mb-3">
                                <label for="exampleInputNo" class="form-label">Kategori Lomba</label>
                                <input type="text" class="form-control" name="kategori_pendaftar" id="kategori_lomba" aria-describedby="emailHelp" value="<?= $mkn ["kategori_pendaftar"]; ?>">
                            </div>
                        <div class="mb-3">
                                <label for="exampleInputNo" class="form-label">Deskripsi Lomba</label>
                                <input type="text" class="form-control" name="deskripsi_lomba" id="deskripsi_lomba" aria-describedby="emailHelp" value="<?= $mkn ["deskripsi_lomba"]; ?>">
                            </div>
                        <div class="mb-3">
                                <label for="exampleInputNo" class="form-label">Biaya Lomba</label>
                                <input type="text" class="form-control" name="biaya_lomba" id="biaya_lomba" aria-describedby="emailHelp"value="<?= $mkn ["biaya_lomba"]; ?>">
                            </div>
                        <div class="mb-3">
                                <label for="exampleInputNo" class="form-label" for="tanggal_lomba">Tanggal Lomba</label>
                                <input type="date" class="form-control" name="tanggal_lomba" id="tanggal_lomba" required value="<?= $mkn ["tanggal_lomba"]; ?>">
                            </div>
                        <div class="mb-3">
                            <label for="exampleInputNo" class="form-label" for="gambar_lomba"></label>
							<img class="gambar_lomba" src="../image/<?= $mkn ["gambar_lomba"]; ?>">
                            <input type="file" class="form-label" name="gambar_lomba" id="gambar_lomba">
                            </div>
                        <div class="text-center my-5"> 
                            <button type="submit" name="submit" class="fw-bold btn btn-custom2">Ubah Data Lomba</button>
                            </div>
                        </form>
                    </div>
                </div>

...
$lomba = query("SELECT * FROM lomba");
	...
	if(isset($_POST["cariBiaya"]) ) {
		$lomba = cariBiaya($_POST["biaya"]);
		}
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
					...
					<input name="biaya" class="form-control me-2" type="search" placeholder="Cari Lomba Berdassarkan Biaya" aria-label="Search" autocomplete="off" id="biaya">
                    <button class="btn btn-custom6 " type= "submit" name="cariBiaya" id="tombol-cariBiaya">Cari</button>
                    </form>
                </div>
            </div>
			<div class="row">

...
$lomba = query("SELECT * FROM lomba");
	...
	if(isset($_POST["cariKategori"]) ) {
			$lomba = cariKategori($_POST["kategori"]);
			}
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <form action="" method="POST" class="d-flex">
                        <input class="form-control me-2" name="kategori" type="search" placeholder="Masukkan kategori yang ingin dicari" aria-label="Search" autocomplete="off" id="kategori">

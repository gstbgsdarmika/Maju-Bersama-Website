...
$lomba = query("SELECT * FROM lomba");
	...
	if(isset($_POST["cariTanggal"]) ) {
		$lomba = cariTanggal($_POST["tanggal1"], $_POST ["tanggal2"]);
		}
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="fw-bold color-acsent mb-4">Daftar Informasi <span class="color-acsent2">Lomba</span></h2>
                    ...
                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                <li><a class="dropdown-item" href="cariKeywordLomba.php">Keyword</a></li>
